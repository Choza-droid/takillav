export default function EventDetailLoading() {
  return (
    <div className="max-w-5xl space-y-6">
      ...
      {/* Hero image */}
      <div className="w-full aspect-video rounded-2xl bg-zinc-200 animate-pulse" />
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="h-7 w-56 bg-zinc-100 animate-pulse rounded-full" />
              <div className="h-7 w-40 bg-zinc-100 animate-pulse rounded-full" />
            </div>
          </div>
